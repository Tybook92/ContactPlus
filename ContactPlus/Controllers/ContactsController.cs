...
using ContactPlus.Models.ViewModels;
...
namespace ContactPlus.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public IActionResult SearchContacts(string searchString)
        {
            ...
            ViewData["CategoryI"] = new SelectList(appUser.Categories, "Id", "Name", 0);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AppUserID,FirstName,LastName,BirthDate,Address1,Address2,City,States,ZipCode,Email,PhoneNumber,Created,ImageFile,ImageData,ImageType")] Contact contact, List<int> CategoryList)
        {
            if (id != contact.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    List<Category> oldCategories = (List<Category>) (await _addressBookService.GetContactCategoriesAsync(contact.Id)).ToList();
